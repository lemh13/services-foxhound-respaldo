...
public class EventualidadController {
	 ...
	 public ResponseEntity<?> modificar(@RequestBody Eventualidad clase, HttpServletRequest request) {
		 return ResponseDefault.ok(service.saveOrUpdate(clase), CLASE, ResponseDefault.SINGULAR);
	 }
	 ...
	 public ResponseEntity<?> borrar(@PathVariable String id, HttpServletRequest request) {
		 ...
		 return ResponseDefault.message(MessageUtil.ELIMINAR_REGISTRO, "Eventualidad");
	 }
