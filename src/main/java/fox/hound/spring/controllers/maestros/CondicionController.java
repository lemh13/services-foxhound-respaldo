...
public class CondicionController {
	...
	public ResponseEntity<?> agregar(@RequestBody Condicion clase, HttpServletRequest request) {
	...
	public ResponseEntity<?> modificar(@RequestBody Condicion clase, HttpServletRequest request) {
		return ResponseDefault.ok(service.saveOrUpdate(clase), CLASE, ResponseDefault.SINGULAR);
	}
	...
	public ResponseEntity<?> borrar(@PathVariable String id, HttpServletRequest request) {
		...
		return ResponseDefault.message(MessageUtil.ELIMINAR_REGISTRO, "Condición");
	}
